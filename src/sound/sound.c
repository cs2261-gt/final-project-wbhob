...
void setupSounds() {
  ...
  REG_SOUNDCNT_H = SND_OUTPUT_RATIO_100 | DSA_OUTPUT_RATIO_100 |
                   ...
                   DSB_OUTPUT_RATIO_100 | DSB_OUTPUT_TO_BOTH | DSB_TIMER1 |
                   DSB_FIFO_RESET;
...
void playSoundA(const signed char *sound, int length, int loops) {
  ...
  DMANow(1, sound, REG_FIFO_A,
         DMA_DESTINATION_FIXED | DMA_AT_REFRESH | DMA_REPEAT | DMA_32);
